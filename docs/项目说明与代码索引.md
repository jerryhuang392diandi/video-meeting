...
### 13.1 首页创建会议：前端 fetch 到 Flask API
...
### 13.4 后端 Socket 入房：写入实时状态并回传 join_ok
...
### 13.6 获取 LiveKit token：前端必须带 participant_sid
...
### 13.10 聊天附件：HTTP 上传后再 Socket 广播
