...
2. [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md) / [English](DEPLOYMENT_GUIDE.en.md): 准备部署、更新服务器或排查线上问题时阅读。
...
| [DEPLOYMENT_GUIDE.md](DEPLOYMENT_GUIDE.md) / [English](DEPLOYMENT_GUIDE.en.md) | 服务器更新、依赖安装、服务重启、日志排查 | 部署和维护项目的人 |
