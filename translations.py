TRANSLATIONS = {'zh': {'app_name': '西小电视频会议系统',
        ...
        'help_page_intro': '这里汇总了登录、注册、创建会议、加入会议、共享屏幕等使用说明。',
        ...
        'quickstart_summary': '本页只讲如何使用会议系统：切换语言、注册登录、创建或加入会议、授权摄像头麦克风、聊天发文件和共享屏幕。',
        ...
        'quickstart_troubleshooting_desc': '如果无法登录、无法打开摄像头、看不到远端画面或附件上传失败，请先刷新页面并检查浏览器权限；仍无法解决时打开用户指南或联系支持。',
 ...
 'en': {'app_name': 'Xidian Video Meeting System',
        ...
        'help_page_intro': 'This page collects basic instructions for sign-in, registration, meeting creation, joining, and screen sharing.',
        ...
        'quickstart_summary': 'This page focuses on using the meeting app: switching language, signing in, creating or joining a room, granting camera/microphone permission, chatting, sending files, and sharing your screen.',
        ...
        'quickstart_troubleshooting_desc': 'If sign-in, camera access, remote video, or attachment upload fails, refresh the page and check browser permissions first. If it still fails, open the user guide or contact support.',
