TRANSLATIONS = {'zh': {'app_name': '西小电视频会议系统',
        ...
        'reset_cycle': '重置周期',
        'traffic_guide': '用户指南',
        'traffic_guide_desc': '当前页面展示的是服务端网络观测结果；切换到 SFU 模式后，不再按用户精确统计媒体流量。',
        ...
        'traffic_turn_relay': '旧版 TURN 统计',
        'traffic_server_observed': '服务端网络观测',
        'traffic_not_tracked': '暂不统计',
        'traffic_tracking_disabled': '当前部署已关闭流量统计与配额扣减。',
        'traffic_tracking_disabled_sfu': '当前使用 SFU 转发，已停用按用户媒体流量扣减，页面仅展示服务器侧网络观测信息。',
        'register_date': '注册时间',
        ...
        'guide_traffic_rules_desc': '当前页面展示的是服务端网络观测；在 SFU 模式下，不再按用户精确扣减媒体流量。每个账号的默认配额仍可保留用于后续兼容或旧模式。',
 ...
 'en': {'app_name': 'Xidian Video Meeting System',
        ...
        'server_traffic_total': 'Total server network',
        ...
        'traffic_guide_desc': 'This page shows server-side network observation. In SFU mode, per-user media traffic '
                              'is no longer tracked precisely.',
        ...
        'traffic_turn_relay': 'Legacy TURN statistics',
        'traffic_server_observed': 'Server-side network observation',
        'traffic_not_tracked': 'Not tracked',
        'traffic_tracking_disabled': 'Traffic accounting and quota deduction are disabled in the current deployment.',
        'traffic_tracking_disabled_sfu': 'SFU forwarding is active, so per-user media traffic deduction is disabled. '
                                         'This page only shows server-side network observation.',
        ...
        'guide_traffic_rules_desc': 'This page shows server-side network observation. In SFU mode, per-user media '
                                    'traffic is no longer deducted precisely. Default quotas remain available for '
