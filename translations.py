TRANSLATIONS = {'zh': {'app_name': '西小电视频会议系统',
        ...
        'manage_account_desc': '管理用户名、会议显示名、地区与文件权限，以及会议默认偏好',
        'profile_saved': '保存成功',
 ...
 'en': {'app_name': 'Xidian Video Meeting System',
        ...
        'manage_account_desc': 'Manage your username, meeting display name, region, file permissions, and meeting defaults',
